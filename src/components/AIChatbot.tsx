...
const knowledge = {
  ...
  projectList: [
    { name: "iVaak AI", desc: "Multi-Tenant Voice AI SaaS (Founder, live at ivaak.ai) — LangGraph, ElevenLabs, Whisper, Twilio, pgvector. Isolated per-tenant state machines, sub-800ms latency, real-time human escalation, active enterprise clients." },
    { name: "TruFix AI", desc: "Autonomous ITSM Platform (Founder) — LangGraph, Claude API, Langfuse. Agents own the full ticket lifecycle with confidence-threshold human routing — 35% MTTR reduction in pilots." },
    { name: "QConnect — Qatar Energy", desc: "Enterprise AI Training Platform — Next.js, FastAPI, pgvector, Claude API, LiveKit, DeepFace. AI-generated quizzes, multilingual RAG Q&A over port manuals, face-presence monitoring; formal executive pilot handover." },
    { name: "BEL Industrial Inspection", desc: "Computer Vision for Bharat Electronics Ltd. — RF-DETR, Roboflow, PyTorch, OpenCV. Real-time bolt & connector detection on live production-line cameras with automated defect alerts." },
...
const rules: Rule[] = [
  ...
  {
    keys: ["ivaak", "vaak"],
    response: `**iVaak AI** (live at **ivaak.ai**) is Muka's multi-tenant Voice AI SaaS — built on LangGraph, ElevenLabs, Whisper, Twilio, Redis, and pgvector. Each tenant gets an isolated state machine, vector knowledge base, and custom escalation policy at sub-800ms latency, with active enterprise clients.`,
  },
  // TruFix AI
  {
    keys: ["trufix", "itsm", "ticket"],
    response: `**TruFix AI** is Muka's autonomous ITSM platform — an AI-native layer above Freshdesk/Zendesk built with LangGraph, Claude API, FastAPI, and Langfuse. Agents own the full ticket lifecycle with confidence-threshold human routing, achieving a **35% MTTR reduction** in pilots, with full Langfuse eval before each release.`,
  },
  // QConnect
  {
    keys: ["qconnect", "qatar", "port"],
    response: `**QConnect** is an enterprise AI training platform Muka built for **Qatar Energy** — Next.js, Fastify, FastAPI, pgvector, Claude API, LiveKit, and DeepFace. It combines video learning with AI-generated quizzes, multilingual RAG Q&A over port-management manuals, and face-presence monitoring — delivered with a formal executive pilot handover.`,
  },
  // BEL
  {
    keys: ["bel", "bharat electronics", "bolt", "inspection"],
    response: `For **BEL (Bharat Electronics Ltd.)**, Muka built a real-time industrial inspection system — RF-DETR transformer-based detection with Roboflow, PyTorch, OpenCV, and FastAPI — detecting bolts, connectors, and assembly components directly from production-line camera feeds with automated defect alerts.`,
  },
  // AI Universee
  {
