...
const projects = [
  {
    title: "iVaak AI",
    category: "Multi-Tenant Voice AI SaaS — Founder · Live at ivaak.ai",
    tools: "LangGraph, ElevenLabs, Whisper, FastAPI, Twilio, Redis, pgvector — isolated per-tenant state machines, sub-800ms latency, real-time human escalation",
    color: "#6366f1",
    tags: ["LangGraph", "ElevenLabs", "Voice AI"],
    image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=600&h=400&fit=crop",
    size: "large",
  },
  {
    title: "TruFix AI",
    category: "Autonomous ITSM Platform — Founder · Live",
    tools: "LangGraph, Claude API, FastAPI, Langfuse, PostgreSQL — agents own the full ticket lifecycle with confidence-threshold human routing, −35% MTTR in pilots",
    color: "#10b981",
    tags: ["LangGraph", "Claude API", "Langfuse"],
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop",
    size: "medium",
  },
  {
    title: "QConnect — Qatar Energy",
    category: "Enterprise AI Training Platform",
    tools: "Next.js 14, Fastify, FastAPI, pgvector, Claude API, LiveKit, DeepFace — AI-generated quizzes, multilingual RAG Q&A over port manuals, face-presence monitoring",
    color: "#0ea5e9",
    tags: ["RAG", "Claude API", "LiveKit"],
    image: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=600&h=400&fit=crop",
    size: "medium",
  },
  {
    title: "BEL Industrial Inspection",
    category: "Computer Vision — Bharat Electronics Ltd.",
    tools: "RF-DETR, Roboflow, PyTorch, OpenCV, FastAPI — real-time bolt & connector detection on live production-line cameras with automated defect alerts",
    color: "#f43f5e",
    tags: ["RF-DETR", "PyTorch", "OpenCV"],
    ...
    <div className="work-section" id="work">
      <div className="work-container section-container">
        ...
        <p className="work-subtitle">
          14 production projects across AI, LLMs, Computer Vision, and Government
        </p>
